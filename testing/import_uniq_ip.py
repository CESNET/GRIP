...
for filename in os.listdir(settings.HOME + 'alerts/'):
    ...
    for i in line['Source']:
        ...
        if 'Type' in i:
            if 'CC' in i['Type']:
                cc.extend(listIp(i['IP4']))
            if 'Botnet' in i['Type']:
                bots.extend(listIp(i['IP4']))
            if 'Spam' in i['Type']:
                spam.extend(listIp(i['IP4']))
...
#_FUNCTION__________________________________________________________________________________
